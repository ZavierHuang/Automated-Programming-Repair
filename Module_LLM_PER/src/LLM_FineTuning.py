...
class TrainingArguments(transformers.TrainingArguments):
    ...
    is_IA3: bool = field(default=False, metadata={"help": "Whether to use IA3."})
...
def main():
    ...
    with autocast():
        ...
        trainer = Trainer(
            ...
            callbacks=[SaveModelCallback()]  # Register the callback here
        )
        trainer.train()
        trainer.save_state()
