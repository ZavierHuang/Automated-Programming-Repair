...
class ModelArguments:
    base_model_path: Optional[str] = field(default="deepseek-ai/deepseek-coder-1.3b-base")
...
def main():
    ...
    for sample in tqdm(buggy_code_list, desc="Generating..."):
        ...
        if generation_args.only_do_beam:
            ...
            # tmp_dict['gold_patch'] = sample['fixed_code']       # ir1 & ir2
            tmp_dict['gold_patch'] = sample['fixed_chunk']        # ir3 & ir4
